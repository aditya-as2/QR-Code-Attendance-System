...
if (isset($_POST['enrollno'])) {
    ...
    $sql = "INSERT INTO `qrform`.`form` (`enrollno`, `fullname`,`semsub`, `dt`) VALUES ('$enrollno', '$fullname','$semsub', current_timestamp());";
    // echo $sql;
    echo "<br>";
        ...
        <div class="mainbox">
            ...
            <?php
                if ($insert==true) {
                    ...
                    window.location = "../form/confirm.php";
                    window.close();
            ...
            <div class="formbox">
                <form action="index.php" method="post">
                    ...
                    <p class="input-text">Enter semester-subject<span>*</span></p>
                    <input type="text" name="semsub" id="semsub" placeholder="Your answer (eg.5TH-DBMS)" oninput="upperCase2()"  required>
                    <div id="locationbox">
