...
function showPosition(position) {
    if (position.coords.latitude >= 22 && position.coords.latitude <= 24 && position.coords.longitude >=  75 && position.coords.longitude <=  80) {
...
function upperCase2() {
    let uc1 = document.getElementById('semsub');
    uc1.value = uc1.value.toUpperCase();
}
